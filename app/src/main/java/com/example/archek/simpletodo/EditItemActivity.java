...
import static com.example.archek.simpletodo.MainActivity.ITEM_POSITION;
import static com.example.archek.simpletodo.MainActivity.ITEM_TEXT;

public class EditItemActivity extends AppCompatActivity {

    //track edit text
    EditText etItemText;
    //position on edited item in List
    int position;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //update of title bar of the activity
